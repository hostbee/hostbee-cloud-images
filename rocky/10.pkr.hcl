...
source "qemu" "rocky" {
  ...
  disk_size                 = "10G"
  headless                  = true
  iso_checksum              = "file:https://mirror.nju.edu.cn/rocky/10/images/x86_64/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2.CHECKSUM"
  iso_url                   = "https://mirror.nju.edu.cn/rocky/10/images/x86_64/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2"
  output_directory          = "${var.cn_flag == "true" ? "output-rocky-10-cn" : "output-rocky-10"}"
  shutdown_command          = "sudo -S bash /root/cleanup.sh"
  shutdown_timeout          = "15s"
  ssh_username              = "builder"
  ssh_private_key_file      = local.ssh_private_key_file
  ssh_clear_authorized_keys = true
  vm_name                   = "rocky-10.img"
  cpu_model                 = "host"
