...
source "qemu" "rocky" {
  ...
  disk_size                 = "10G"
  headless                  = true
  iso_checksum              = "file:https://mirrors.ustc.edu.cn/rocky/9/images/x86_64/Rocky-9-GenericCloud.latest.x86_64.qcow2.CHECKSUM"
  iso_url                   = "https://mirrors.ustc.edu.cn/rocky/9/images/x86_64/Rocky-9-GenericCloud.latest.x86_64.qcow2"
