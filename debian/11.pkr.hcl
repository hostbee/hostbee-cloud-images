...
source "qemu" "debian" {
  ...
  disk_size                 = "10G"
  headless                  = true
  iso_checksum              = "file:https://mirrors.cernet.edu.cn/debian-cdimage/cloud/bullseye/latest/SHA512SUMS"
  iso_url                   = "https://mirrors.cernet.edu.cn/debian-cdimage/cloud/bullseye/latest/debian-11-generic-amd64.qcow2"
  output_directory          = "${var.cn_flag == "true" ? "output-debian-11-cn" : "output-debian-11"}"
  shutdown_command          = "sudo -S shutdown -P now"
  ssh_username              = "builder"
  ssh_private_key_file      = local.ssh_private_key_file
  ssh_clear_authorized_keys = true
  vm_name                   = "debian-11.img"
