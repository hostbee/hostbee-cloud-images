...
source "qemu" "debian" {
  ...
  disk_size                 = "10G"
  headless                  = true
  iso_checksum              = "file:https://mirror.nju.edu.cn/debian-cdimage/cloud/trixie/latest/SHA512SUMS"
  iso_url                   = "https://mirror.nju.edu.cn/debian-cdimage/cloud/trixie/latest/debian-13-generic-amd64.qcow2"
  output_directory          = "${var.cn_flag == "true" ? "output-debian-13-cn" : "output-debian-13"}"
  shutdown_command          = "sudo -S bash /root/cleanup.sh"
  shutdown_timeout          = "15s"
  ssh_username              = "builder"
  ssh_private_key_file      = local.ssh_private_key_file
  ssh_clear_authorized_keys = true
  vm_name                   = "debian-13.img"
